...
class main_window(tk.Tk):
    ...
    def __init__(self):
        ...
        self.progressbar.grid(column=0, row=2, columnspan=2)
    ...
    def show_detail(self):
        self.progressbar.grid(column=0, row=2, columnspan=2)
        self.progresslabel.grid(column=0, row=3)
        self.speedlabel.grid(column=1, row=3)
        try:
            ...
            for i, (name, value) in enumerate(data.items()):
                ...
                label.grid(column=0, row=4 + i)
                entry.grid(column=1, row=4 + i)
    ...
    def start_download_thread(self):
        try:
            ...
            download_main(
                ...
                URLs, None, download_inf_queue, output_dir='./',
                merge=not None,
